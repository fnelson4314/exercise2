...
function main() {
    ...
    var ulc = new Color(0, 255, 255, 1); // upper left corner color: red
    var urc = new Color(255, 0, 255, 1.0); // upper right corner color: green
    var llc = new Color(255, 255, 0, 1); // lower left corner color: blue
    var lrc = new Color(255, 192, 203, 1); // lower right corner color: black
